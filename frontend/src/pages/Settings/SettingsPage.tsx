  ...
  return (
    <section className="space-y-6">
      <div className="rounded-2xl border border-[var(--color-border)] bg-white p-6 shadow-sm">
        ...
        <p className="mt-1 text-sm text-slate-500">Manage your profile and workspace access.</p>
      ...
      <div className="rounded-2xl border border-[var(--color-border)] bg-white p-6 shadow-sm">
        <h3 className="text-lg font-semibold text-slate-900">Companies / Workspaces</h3>
        <p className="mt-1 text-sm text-slate-500">Create and manage sub-companies for your finance team.</p>
          ...
          {legalEntities.map((entity) => (
            ...
            >
              ...
              <div className="flex items-center gap-2">
                ...
                {entity.isDefault ? (
                  <span className="rounded-full bg-amber-100 px-2 py-0.5 text-xs font-semibold text-amber-700">Default</span>
                ) : (
        ...
        <form onSubmit={onCreateWorkspace} className="mt-5 grid gap-3 md:grid-cols-2">
          <input
            value={workspaceName}
